          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                  <div class='row'>
                    <div class='col-8'>
                    <h3 class="card-title">Add and Edit Countries and codes here</h3>
                    </div>
                    <div class='col-4 text-right'>
                        <button class='btn btn-primary btn-sm' data-target='#countryModal' data-toggle='modal'><i class='fas fa-plus'></i> | Add</button>
                    </div>
                  </div>
              </div>
              <!-- /.card-header -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method='POST' action="{{url('admin/countries/add')}}">
            @csrf
